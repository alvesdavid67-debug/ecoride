...
--
-- Hôte : 127.0.0.1
-- Généré le : mer. 20 mai 2026 à 15:04
...
CREATE TABLE `covoiturage` (
  ...
  `voyage_eco` tinyint(1) DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `covoiturage` (`covoiturage_id`, `date_depart`, `heure_depart`, `lieu_depart`, `date_arrivee`, `heure_arrivee`, `lieu_arrivee`, `statut`, `nombre_place`, `prix_personne`, `voyage_eco`) VALUES
(3, '2026-05-25', '08:00:00', 'paris', '0000-00-00', '12:00:00', 'lyon', 'actif', 3, 15, 1),
(4, '2026-06-06', '07:00:00', 'Strasbourg', '2026-06-06', '11:00:00', 'Paris', 'actif', 3, 3, 1);
...
INSERT INTO `reservation` (`reservation_id`, `utilisateur_id`, `covoiturage_id`, `statut`, `date_reservation`) VALUES
(1, 2, 3, 'annulée', '2026-05-18');
...
(2, '', '', 'test@test.fr', '$2y$10$WPAUTOtQQx1NpWhePlslJufsOwC8yrENUybIcqx/JyQlV7RCVT3kS', NULL, NULL, NULL, NULL, 'test', 18);
...
--
ALTER TABLE `covoiturage`
  MODIFY `covoiturage_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `avis`
  ADD CONSTRAINT `avis_ibfk_1` FOREIGN KEY (`covoiturage_id`) REFERENCES `covoiturage` (`covoiturage_id`);

--
-- Contraintes pour la table `reservation`
--
ALTER TABLE `reservation`
  ADD CONSTRAINT `reservation_ibfk_1` FOREIGN KEY (`utilisateur_id`) REFERENCES `utilisateur` (`utilisateur_id`),
  ADD CONSTRAINT `reservation_ibfk_2` FOREIGN KEY (`covoiturage_id`) REFERENCES `covoiturage` (`covoiturage_id`);
--
...
--
ALTER TABLE `utilisateurs`
  MODIFY `login` int(255) NOT NULL AUTO_INCREMENT;
--
...
('root', '[{\"db\":\"ecoride\",\"table\":\"covoiturage\"},{\"db\":\"ecoride\",\"table\":\"utilisateur\"},{\"db\":\"ecoride\",\"table\":\"reservation\"},{\"db\":\"persona\",\"table\":\"utilisateurs\"},{\"db\":\"persona\",\"table\":\"Utilisateurs\"},{\"db\":\"test\",\"table\":\"persona\"}]');
...
('root', '2026-05-20 13:03:56', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"fr\"}');
